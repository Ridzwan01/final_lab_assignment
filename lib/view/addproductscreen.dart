...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  void _addHomestay() {
    ...
    if (_name.isNotEmpty && _desc.isNotEmpty && _price.isNotEmpty && _guest.isNotEmpty && _address.isNotEmpty && _address.isNotEmpty && _state.isNotEmpty && _local.isNotEmpty && base64Image.isNotEmpty) {
      http.post(Uri.parse("${Config.server}/homestay_raya/mobile/php/add_homestay.php"),
      body: {
        "name": _name,
        "desc":_desc,
        "price": _price,
